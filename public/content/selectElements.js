    ...
    case "select":
      ...
      if (allElements.length > 1) {
        for (let i = 0; i < allElements.length; i++) {
          ...
          overlay.style =
            "font-family: Impact, seif; background-color:yellow; width: auto; text-align:center; display:inline; border: 2px solid orange; border-radius:8px; left:0 position: absolute; z-index:999";
          overlay.innerText = i;
